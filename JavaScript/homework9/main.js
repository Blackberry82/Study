...
// blocks.innerText = 'Hello, my Heart!';

//     - додати йому класи wrap, collapse, alpha, beta
// blocks.classList.add('wrap', 'collapse', 'alpha', 'beta');

// - додати стилі(довільні значення) : колір фону, колір тексту, розмір тексту
// blocks.style.background = 'green';
// blocks.style.color = 'white';
// blocks.style.fontSize = '100px';

// - додати цей блок в body.
// const blockDiv = document.body.appendChild(blocks);
...
//     one.appendChild(header);
//     const paragraf = document.createElement('p');
//     paragraf.classList.add('description');
//     paragraf.innerText = `${Element.monthDuration}`;
//     one.appendChild(paragraf);
// // }
...
//     address.innerHTML = `${user.address.street} <br> ${user.address.suite} <br> ${user.address.city} <br> ${user.address.zipcode}`
//     const geo = document.createElement('p');
//     geo.innerHTML = `${user.address.geo.lat} <br> ${user.address.geo.lng}`;
//
...
//     company.innerHTML = `${user.company.name} <br> ${user.company.catchPhrase} <br> ${user.company.bs}`;
// group.classList.add('person');
//     user1.appendChild(id);
//     user1.appendChild(name);
//     user1.appendChild(username);
//     user1.appendChild(email);
//     user1.appendChild(address);
//     address.appendChild(geo);
//     user1.appendChild(phone);
//     user1.appendChild(web);
//     user1.appendChild(company);
//     group.appendChild(user1);
...
//     divEl.setAttribute('class', 'member');
//
//     const name = document.createElement('h2');
...
//     divEl.append(name, age, info, photo);
...
//     term.innerText = item.monthDuration;
//
//     const time = document.createElement('p');
//     time.innerText = item.hourDuration;
//
//     const block = document.createElement('ol');
//     block.style.border = (`solid 5px pink`);
//     for (const modul of item.modules) {
//         const list = document.createElement('li');
//             list.innerHTML = modul;
